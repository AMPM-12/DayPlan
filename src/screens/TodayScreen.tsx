...
import { formatDateHeading, nowMinutes, todayDateString } from '../utils/time'
...
export function TodayScreen() {
  const { plan, today, toggleComplete, startNow, resetOverride, addLog, theme, setTheme, refreshIfNewDay } =
    useAppData()
  const now = useNow()
  ...
  const items = computeSchedule(plan, today.completedIds, today.override, mins)
